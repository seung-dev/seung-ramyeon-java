package seung.boot.configuration.web.rest.service.impl;
...
import seung.boot.configuration.web.rest.service.SRestS;
import seung.boot.configuration.web.rest.types.SRestHmac;
import seung.boot.configuration.web.types.SRequestAttribute;
import seung.boot.configuration.web.types.SRequestBody;
