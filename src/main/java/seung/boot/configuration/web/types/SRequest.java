...
public class SRequest {
	...
	public static final String _S_REQUEST_ATTRIBUTE_NAME = "request_attribute";
	
	public static final String[] _S_REMOTE_ADDR_HEADER_NAMES = {
			"x-forwarded-for"
			, "proxy-client-ip"
	...
	public static String remote_addr(HttpServletRequest request) {
		String remote_addr = "";
		for(String header_name : _S_REMOTE_ADDR_HEADER_NAMES) {
	...
	public static SRequestAttribute request_attribute(HttpServletRequest request) {
		return (SRequestAttribute) request.getAttribute(_S_REQUEST_ATTRIBUTE_NAME);
